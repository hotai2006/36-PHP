...
--
-- Máy chủ: mysql-db
-- Thời gian đã tạo: Th6 08, 2026 lúc 01:40 PM
...
CREATE TABLE `products` (
  ...
  `product_detailDesc` text COLLATE utf8mb4_unicode_ci,
  `product_shortDesc` text COLLATE utf8mb4_unicode_ci,
  `product_price` decimal(10,2) NOT NULL,
  `product_factory` text COLLATE utf8mb4_unicode_ci,
  `product_target` text COLLATE utf8mb4_unicode_ci,
...
(1, 'Nike Air Zoom Pegasus', 'Giày chạy bộ nhẹ, êm và thoáng khí cho tập luyện hằng ngày.', 'Giày chạy êm, nhẹ.', 2390000.00, 'Nike', 'Chạy bộ', 'Giày thể thao', 100, 'NikeAirZoomPegasus.jpg', NULL, NULL, 5),
(2, 'Adidas Training Tee', 'Áo thun thể thao co giãn, thấm hút mồ hôi nhanh.', 'Áo tập thoáng mát.', 890000.00, 'Adidas', 'Tập luyện', 'Áo thể thao', 80, 'AdidasTrainingTee.jpg', NULL, NULL, 5),
(3, 'Puma Run Shorts', 'Quần short thể thao thoải mái, phù hợp chạy bộ và gym.', 'Quần short co giãn.', 650000.00, 'Puma', 'Chạy bộ', 'Quần thể thao', 90, 'PumaRunShorts.jpg', NULL, NULL, 5),
(4, 'Under Armour Hoodie', 'Áo khoác thể thao giữ ấm nhẹ, phù hợp khởi động và di chuyển.', 'Áo khoác thể thao.', 1590000.00, 'Under Armour', 'Tập luyện', 'Áo thể thao', 120, 'UnderArmourHoodie.jpg', NULL, NULL, 5),
(5, 'Asics Gel-Kayano', 'Giày chạy bộ ổn định, đệm tốt, phù hợp quãng đường dài.', 'Giày chạy bền bỉ.', 3290000.00, 'Asics', 'Chạy bộ', 'Giày thể thao', 60, 'AsicsGel-Kayano.jpg', NULL, NULL, 5),
(6, 'Reebok Training Bag', 'Túi đựng đồ tập rộng rãi, tiện mang đến phòng gym.', 'Túi tập tiện dụng.', 720000.00, 'Reebok', 'Phụ kiện', 'Phụ kiện thể thao', 75, 'ReebokTrainingBag.jpg', NULL, NULL, 5),
(7, 'New Balance Fresh Foam', 'Giày chạy bộ êm chân, trọng lượng nhẹ, ôm chân tốt.', 'Giày chạy êm ái.', 2590000.00, 'New Balance', 'Chạy bộ', 'Giày thể thao', 110, 'NewBalanceFreshFoam.jpg', NULL, NULL, 5),
(8, 'Decathlon Domyos Legging', 'Quần legging tập luyện co giãn, hỗ trợ vận động linh hoạt.', 'Quần tập co giãn.', 540000.00, 'Decathlon', 'Tập luyện', 'Quần thể thao', 50, 'DecathlonDomyosLegging.jpg', NULL, NULL, 5),
(9, 'Nike Dri-FIT Cap', 'Mũ thể thao nhẹ, thoáng khí, chống nắng khi vận động ngoài trời.', 'Mũ thể thao nhẹ.', 420000.00, 'Nike', 'Phụ kiện', 'Phụ kiện thể thao', 40, 'NikeDri-FITCap.jpg', NULL, NULL, 5),
(10, 'Adidas Predator Ball', 'Bóng đá độ nảy chuẩn, phù hợp tập luyện và thi đấu sân cỏ.', 'Bóng đá chuẩn.', 890000.00, 'Adidas', 'Bóng đá', 'Bóng thể thao', 95, 'AdidasPredatorBall.jpg', NULL, NULL, 5),
(11, 'Puma DryCELL Jersey', 'Áo đấu thoáng khí, nhẹ, phù hợp bóng đá và chạy bộ.', 'Áo đấu thể thao.', 990000.00, 'Puma', 'Thi đấu', 'Áo thể thao', 35, 'PumaDryCELLJersey.jpg', NULL, NULL, 5),
(12, 'Mizuno Wave Rider', 'Giày chạy bộ linh hoạt, đệm tốt, hỗ trợ sải chân ổn định.', 'Giày chạy linh hoạt.', 2990000.00, 'Mizuno', 'Chạy bộ', 'Giày thể thao', 25, 'MizunoWaveRider.jpg', NULL, NULL, 5),
(13, 'Under Armour Compression Top', 'Áo ôm thể thao hỗ trợ cơ bắp, thoát mồ hôi nhanh.', 'Áo nén tập luyện.', 1190000.00, 'Under Armour', 'Tập luyện', 'Áo thể thao', 85, 'UnderArmourCompressionTop.jpg', NULL, NULL, 5),
(14, 'Reebok Nano X', 'Giày training đa năng, phù hợp squat, cardio và tập sức mạnh.', 'Giày training đa năng.', 2690000.00, 'Reebok', 'Gym', 'Giày thể thao', 70, 'ReebokNanoX.jpg', NULL, NULL, 5),
(15, 'Lining Badminton Racket', 'Vợt cầu lông cân bằng tốt, dễ kiểm soát và tạo lực đánh.', 'Vợt cầu lông.', 1490000.00, 'Lining', 'Cầu lông', 'Dụng cụ thể thao', 90, 'LiningBadmintonRacket.jpg', NULL, NULL, 5),
(16, 'Yonex Court Shoes', 'Giày cầu lông bám sân tốt, hỗ trợ đổi hướng nhanh.', 'Giày cầu lông.', 2190000.00, 'Yonex', 'Cầu lông', 'Giày thể thao', 30, 'YonexCourtShoes.jpg', NULL, NULL, 5),
(17, 'Nike Grip Gloves', 'Găng tay tập gym tăng độ bám, hỗ trợ bảo vệ bàn tay.', 'Găng tay tập gym.', 390000.00, 'Nike', 'Phụ kiện', 'Phụ kiện thể thao', 55, 'NikeGripGloves.jpg', NULL, NULL, 5),
(18, 'Adidas Backpack', 'Balo thể thao gọn nhẹ, nhiều ngăn, phù hợp đi tập và đi học.', 'Balo thể thao.', 1090000.00, 'Adidas', 'Phụ kiện', 'Phụ kiện thể thao', 100, 'AdidasBackpack.jpg', NULL, NULL, 5),
(19, 'Puma Sports Bra', 'Áo bra thể thao hỗ trợ tốt, thoải mái cho các buổi tập.', 'Áo bra thể thao.', 790000.00, 'Puma', 'Tập luyện', 'Áo thể thao', 85, 'PumaSportsBra.jpg', NULL, NULL, 5),
(20, 'Asics Track Jacket', 'Áo khoác chạy bộ nhẹ, chống gió, dễ mặc khi khởi động.', 'Áo khoác chạy bộ.', 1690000.00, 'Asics', 'Chạy bộ', 'Áo thể thao', 60, 'AsicsTrackJacket.jpg', NULL, NULL, 5),
(21, 'New Balance Run Shorts', 'Quần chạy bộ nhẹ, thoáng, không bám dính khi vận động.', 'Quần chạy nhẹ.', 690000.00, 'New Balance', 'Chạy bộ', 'Quần thể thao', 95, 'NewBalanceRunShorts.jpg', NULL, NULL, 5),
(22, 'Decathlon Yoga Mat', 'Thảm tập yoga chống trượt, êm và dễ cuộn gọn.', 'Thảm tập yoga.', 450000.00, 'Decathlon', 'Yoga', 'Dụng cụ thể thao', 45, 'DecathlonYogaMat.jpg', NULL, NULL, 5),
(23, 'Mizuno Shin Guards', 'Ốp bảo vệ ống chân, phù hợp bóng đá và các buổi tập đối kháng.', 'Ốp bảo vệ chân.', 520000.00, 'Mizuno', 'Bóng đá', 'Phụ kiện thể thao', 90, 'MizunoShinGuards.jpg', NULL, NULL, 5),
(24, 'Under Armour Training Pants', 'Quần dài thể thao co giãn, phù hợp tập gym và đi lại.', 'Quần dài thể thao.', 1290000.00, 'Under Armour', 'Tập luyện', 'Quần thể thao', 75, 'UnderArmourTrainingPants.jpg', NULL, NULL, 5),
(25, 'Nike Performance Socks', 'Tất thể thao bền, thoáng khí, hỗ trợ luyện tập hàng ngày.', 'Tất thể thao bền.', 240000.00, 'Nike', 'Phụ kiện', 'Phụ kiện thể thao', 80, 'NikePerformanceSocks.jpg', NULL, NULL, 5);
...
CREATE TABLE `shippings` (
  ...
  `shipping_status` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Đang chuẩn bị',
