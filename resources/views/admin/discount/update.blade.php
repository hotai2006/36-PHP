                            ...
                            <form method="post" action="/admin/discount/update/{{$productDiscount->id}}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                                        ...
                                        value="{{ old('start_date', $productDiscount->start_date ? \Carbon\Carbon::parse($productDiscount->start_date)->format('Y-m-d') : '') }}">
                                    @error('start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control @error('end_date') is-invalid @enderror"
                                        ...
                                        value="{{ old('end_date', $productDiscount->end_date ? \Carbon\Carbon::parse($productDiscount->end_date)->format('Y-m-d') : '') }}">
                                    @error('end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
