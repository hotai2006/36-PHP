...
<body>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Nhập email để nhận mã OTP xác thực</p>
                    </div>
                    ...
                    <form method="post" action="{{ route('register') }}" id="registerForm">
                        ...
                        <!-- Ô 2: Mã OTP (hiện sau khi gửi OTP) -->
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="user_name" class="form-control form-control-lg"
                                placeholder="Nhập tên người dùng" name="user_name" value="{{ old('user_name') }}" />
                        ...
                        <div class="form-outline mb-4">
                            <input type="password" id="user_password" class="form-control form-control-lg"
                                placeholder="Nhập mật khẩu (tối thiểu 6 ký tự)" name="user_password" minlength="6" />
                    ...
                    <p class="small fw-bold mt-4 pt-1 mb-0 text-center">
                        Đã có tài khoản? <a href="{{ route('login') }}" class="link-danger">Đăng nhập</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function startOtpCooldown(seconds = 60) {
            ...
            cooldownInterval = setInterval(() => {
                ...
                if (cooldownSeconds <= 0) {
                    ...
                    localStorage.removeItem('otp_cooldown_expires');
                    localStorage.removeItem('otp_cooldown_email');
                } else {
                    btnSendOtp.innerHTML = '<i class="fas fa-history me-1"></i> Gửi lại sau ' + cooldownSeconds + 's';
                }
            }, 1000);
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            const expires = localStorage.getItem('otp_cooldown_expires');
            const email = localStorage.getItem('otp_cooldown_email');
            
            if (expires && email) {
                const remaining = Math.ceil((parseInt(expires) - Date.now()) / 1000);
                if (remaining > 0) {
                    // Điền lại email và hiển thị ô nhập OTP
        ...
        btnSendOtp.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    localStorage.setItem('otp_cooldown_expires', expiresAt);
                    localStorage.setItem('otp_cooldown_email', email);
