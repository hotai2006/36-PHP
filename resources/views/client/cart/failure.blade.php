    ...
    <div class="container-fluid client-content-container">
        <div class="container py-5 text-center">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <i style="font-size: 100px; color: #dc3545;" class="fas fa-times-circle mb-3"></i>
                    <h2 class="fw-bold text-danger mb-2">Thanh toán thất bại</h2>
                    <h5 class="text-muted mb-3">Đã xảy ra lỗi trong quá trình xử lý giao dịch</h5>
                    @if(session('error') || isset($error))
                        <p class="text-danger fw-bold mb-4">{{ session('error') ?? $error }}</p>
                    @endif
                    <p class="text-muted small mb-4">T-Sports - Uy tín - chất lượng</p>
                    <a class="btn border-secondary rounded-pill py-2 px-4" href="/">Quay lại trang chủ</a>
                </div>
            </div>
        </div>
    </div>
