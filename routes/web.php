...
Route::middleware(['auth', 'role:1'])->group(function () {
    ...
    // Order routes moved outside this group to allow both roles 1 and 2
    ...
    Route::post('/admin/coupon/delete/{id}', [CouponController::class, 'destroy']);
});
...
Route::get('/api/products/suggestions', [ProductController::class, 'suggestProducts']);
...
Route::delete('/cart/clear-all', [CartController::class, 'clearAllCart'])->name('cart.clearAll');
...
Route::post('/change-role', [HomePageController::class, 'changeRole']);

// Favorites
Route::post('/favorite/toggle', [FavoriteController::class, 'toggleFavoriteAjax'])->name('favorite.toggle');
Route::get('/favorites', [FavoriteController::class, 'getFavoritesPage'])->name('favorites.show');